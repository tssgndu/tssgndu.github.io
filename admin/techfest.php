...
<?php
 ...
 include 'header.php';?>
	...
	<form role="form" action="techfest.php" method="post" enctype="multipart/form-data"
			 style="color:white; padding:2%;border:1px solid white;border-radius:1%">
	
	<h1>Add New Tech Fest Event</h1>
...
$query123=mysqli_query($conn,"INSERT INTO techfest(tfevent_name,tfevent_day, tfevent_month, tfevent_year, tfevent_pmplt)
