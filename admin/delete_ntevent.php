...
$query3=mysqli_query($conn, "select * from nontech_events  ");
$query4=mysqli_fetch_array($query3);
echo mysqli_error($conn);
if($query4){
$query1=mysqli_query($conn, "select * from nontech_events ");
...
{
echo "<tr><td><a href='delete2.php?id=".$query2['id']."'  >".$query2['id']."</a></td>";
echo "<td>".$query2['nevent_name']."</td>";
echo "<td>".$query2['nevent_date']."</td></tr>";
