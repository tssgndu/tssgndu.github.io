...
$query3=mysqli_query($conn, "select * from techfest  ");
$query4=mysqli_fetch_array($query3);
echo mysqli_error($conn);
if($query4){
$query1=mysqli_query($conn, "select * from techfest ");
...
{
echo "<tr><td><a href='delete4.php?id=".$query2['id']."'  >".$query2['id']."</a></td>";
echo "<td>".$query2['tfevent_name']."</td>";
echo "<td>".$query2['tfevent_date']."</td></tr>";
