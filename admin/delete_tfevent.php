...
<!DOCTYPE HTML>
<html>
<head><title>Technical Students Society</title>
 ...
 include 'header.php'?><br/>
  ...
  <div class="col-sm-12"  >
	   ...
	   <div class="row">
			  ...
			  <center> <h2 style="color:white"><u>Tech Fest Events</u></h2> </center>
...
if($query4){
$query1=mysqli_query($conn, "select * from events_record where techfestflag='category-4' ORDER BY id DESC ");
...
{
echo "<tr><td><a href='delete4.php?id=".$query2['id']."' class='btn btn-danger'>DELETE</a></td>";
echo "<td><a href='update_techfest.php?id=".$query2['id']."'  class='btn btn-primary'>UPDATE</a></td>";
